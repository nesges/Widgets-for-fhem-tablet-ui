...
"?"+(new Date).valueOf()},load:function(){DEBUG&&console.log('ion load'),this.no_file?m('No sources for "'+this.options.name+'" sound :('):(this.createUrl(),DEBUG&&console.log('ion-url:', this.url),this.request=new XMLHttpRequest,this.request.open("GET",this.url,!0),this.request.responseType="arraybuffer",this.request.addEventListener("load",this.ready.bind(this),!1),this.request.addEventListener("error",this.error.bind(this),!1),this.request.send())},reload:function(){this.ext++;this.options.supported[this.ext]?this.load():(this.no_file=!0,m('No sources for "'+this.options.name+
